const films = [
  {
    ...
    premis:
      "Apa yang terjadi jika kasih sayang yang tulus tidak pernah mendapat balasan? 'Kasut untuk Mak Ngah' mengisahkan perjuangan seorang anak yatim piatu yang berusaha keras membahagiakan rumah barunya meskipun harapan tampak jauh. Akankah ketulusan ini akhirnya menyentuh hati mereka? Temukan jawabannya dalam short movie ini.",
    poster: "/thumbnails/1.png",
    background: "/thumbnails/1.png",
    videoId: "uUGi6uewrDc", // ID YouTube
    rating: "8.5",
    youtubeUrl: "https://www.youtube.com/watch?v=uUGi6uewrDc",
  },
  {
    title: "Baju Kurung",
    premis:
      "Nizam meninggalkan keluarganya untuk mencari pekerjaan di kota. Meskipun ibunya dan adiknya hidup dalam keterbatasan, Nizam bersikeras pergi untuk merubah nasib keluarganya. Saat Azmi adiknya mencoba meneruskan tanggung jawabnya, sebuah kecelakaan tragis tak terduga pun terjadi.",
    poster: "/thumbnails/2.png",
    background: "/thumbnails/2.png",
    videoId: "qX2PZhwS8Mk",
    rating: "9.0",
    youtubeUrl: "https://www.youtube.com/watch?v=qX2PZhwS8Mk",
  },
  {
    title: "Dibalik Luka Lama",
    premis:
      "Dalam suasana Lebaran yang seharusnya penuh kebahagiaan, Izwan justru dihadapkan pada amarah dan luka lama. Akankah ia terus terjebak dalam masa lalu, atau memilih memaafkan dan melangkah ke depan?",
    poster: "/thumbnails/3.png",
    background: "/thumbnails/3.png",
    videoId: "z6WdME5yjyY",
    rating: "8.7",
